...
At the end of this paper, I describe possible ways of improving the Mappa Mundi algorithm 
using LLMs (Large
Language Models such as ChatGPT).
I also discuss the opposite
road,
...
incapable of such precise and exquisite curve-fitting.
ChatGPT and 
comparable LLMs 
have finally reached the point where they 
can greatly aid
in practice of Pearl CI.


\section{Possible Improvements
of LLMs 
using the Mappa Mundi algorithm}
...
perform SM in a trial an error way, as in 
