...
It might also work well on a corpus of time-stamped logs maintained by a person
...
a distance between the two nodes (i.e., clauses or sentences). On the other hand, the
...
do a superb job performing this task, I
